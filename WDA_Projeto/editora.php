<?php
    ...
    if(!empty($_GET['search'])){
        ...
        $sql = "SELECT * FROM editora WHERE id LIKE '%$data%' OR nome LIKE '%$data%' OR telefone LIKE '%$data%' OR email LIKE '%$data%'  ORDER BY id ASC";
    }
    else{
...
<body>
                ...
                <div class="corpo-modal">
                  <form action="editora.php" method="POST">
                    ...
                    <div class="input-modal" id="area-cidade">
                      <input type="Number" placeholder="" name="telefone" required >
  ...
  <tbody>
    ...
    while($user_data = mysqli_fetch_assoc($result)){
      ...
      <a href='edit/edit-editora.php?id=$user_data[id]' class='butao' id='bt1'>
      <img src='images/pencil-fill.svg' alt='pencil' >
      </a>
      <a href='delete/delet-editora.php?id=$user_data[id]' class='butao' id='bt2'>
  ...
  ?>
       ...
       <?php
        if(isset($_POST['submit'])){
            ...
            $result = mysqli_query($conexao, "INSERT INTO editora ( nome , telefone , email) VALUES ('$nome', '$telefone', '$email')");
